...
exports.postData = function(path,parameters,callback)
{
...
{
	postData("/v1/server/create?api_key="+apiKey,'DCID='+dataCenterId+'&OSID='+osId+'&VPSPLANID='+vpsPlanId,function(err,result)
	{	
		if(err)
			callback(err, result);
...
exports.listServer = function(apiKey,callback)
{
